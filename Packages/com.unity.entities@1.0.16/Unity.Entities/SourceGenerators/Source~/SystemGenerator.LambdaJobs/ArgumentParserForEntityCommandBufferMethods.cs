...
namespace Unity.Entities.SourceGen.LambdaJobs
{
    internal static class ArgumentParserForEntityCommandBufferMethods
    {
        ...
        public static (ArgumentType Type, string Value) ParseNamedArgument(ArgumentSyntax argument, string argumentName)
        {
        ...
        public static (ArgumentType Type, string Value) ParseUnnamedArgument(ArgumentSyntax argument, int position, IEnumerable<IParameterSymbol> methodParameters)
        {
