...
namespace Unity.Entities.SourceGen.LambdaJobs
{
    ...
    public abstract class LambdaParamDescription
    {
        ...
        internal virtual string FieldAssignmentInGeneratedJobChunkType(LambdaJobDescription lambdaJobDescription) => null;
     ...
     public class LambdaParamDescription_EntityCommandBuffer : LambdaParamDescription
    {
        ...
        public (bool IsImmediate, ScheduleMode ScheduleMode, ITypeSymbol SystemType) Playback { get; set; }

        internal override string FieldAssignmentInGeneratedJobChunkType(LambdaJobDescription _)
        {
    ...
    class LambdaParamDescription_SharedComponent : LambdaParamDescription, ISharedComponentParamDescription
    {
        ...
        internal override string FieldAssignmentInGeneratedJobChunkType(LambdaJobDescription lambdaJobDescription) => $@"__{Syntax.Identifier}TypeHandle = GetSharedComponentTypeHandle<{TypeSymbol.ToFullName()}>()";
    ...
    class LambdaParamDescription_NativeThreadIndex : LambdaParamDescription
    {
        ...
        internal override string FieldAssignmentInGeneratedJobChunkType(LambdaJobDescription lambdaJobDescription) => $@"__NativeThreadIndex = 0";
