    ...
    partial class CompanionGameObjectUpdateTransformSystem : SystemBase
    {
        ...
        protected override void OnCreate()
        {
            ...
            m_CreatedQuery = new EntityQueryBuilder(Allocator.Temp)
                .WithAll<CompanionLink, NonUniformScale>()
        ...
        protected override void OnUpdate()
        {
            ...
            Dependency = new CopyTransformJob
            {
                ...
                nonUniformScales = GetComponentLookup<NonUniformScale>(),
                entities = m_Entities
        ...
        struct CopyTransformJob : IJobParallelForTransform
        {
            ...
            [ReadOnly]
            [NativeDisableParallelForRestriction] public ComponentLookup<NonUniformScale> nonUniformScales;
            [ReadOnly] public NativeList<Entity> entities;

            public unsafe void Execute(int index, TransformAccess transform)
            {
                var scales = nonUniformScales[entities[index]];
                ...
                transform.localScale = new Vector3(mat.lossyScale.x * scales.Value.x, mat.lossyScale.y * scales.Value.y, mat.lossyScale.z);
            }
        }
    }
}
