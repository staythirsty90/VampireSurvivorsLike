...
namespace ImGuiNET.Unity
{
    ...
    unsafe class PlatformCallbacks
    {
        ...
        public void Assign(ImGuiIOPtr io)
        {
            ...
            //ImGuiIOPtr.SetClipboardTextFn = Marshal.GetFunctionPointerForDelegate(_setClipboardText);
            //io.GetClipboardTextFn = Marshal.GetFunctionPointerForDelegate(_getClipboardText);
            //ImGuiIOPtr.GetClipboardTextFn = Marshal.GetFunctionPointerForDelegate(_getClipboardText);
            //io.ImeSetInputScreenPosFn = Marshal.GetFunctionPointerForDelegate(_imeSetInputScreenPos);
            //ImGuiIOPtr.ImeSetInputScreenPosFn = Marshal.GetFunctionPointerForDelegate(_imeSetInputScreenPos);
#if IMGUI_FEATURE_CUSTOM_ASSERT
        ...
        public void Unset(ImGuiIOPtr io)
        {
            ...
            //ImGuiIOPtr.SetClipboardTextFn = IntPtr.Zero;
            //io.GetClipboardTextFn = IntPtr.Zero;
            //ImGuiIOPtr.GetClipboardTextFn = IntPtr.Zero;
            //ImGuiIOPtr.ImeSetInputScreenPosFn = IntPtr.Zero;
