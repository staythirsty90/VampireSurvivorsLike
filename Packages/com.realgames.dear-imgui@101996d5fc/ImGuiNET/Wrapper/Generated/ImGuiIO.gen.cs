...
namespace ImGuiNET
{
    ...
    {
        public static ImGuiIO* NativePtr { get; set; }
        ...
        public static ref IntPtr GetClipboardTextFn => ref UnsafeUtility.AsRef<IntPtr>(&NativePtr->GetClipboardTextFn);
        public static ref IntPtr SetClipboardTextFn => ref UnsafeUtility.AsRef<IntPtr>(&NativePtr->SetClipboardTextFn);
        public IntPtr ClipboardUserData { get => (IntPtr)NativePtr->ClipboardUserData; set => NativePtr->ClipboardUserData = (void*)value; }
        public static ref IntPtr ImeSetInputScreenPosFn => ref UnsafeUtility.AsRef<IntPtr>(&NativePtr->ImeSetInputScreenPosFn);
